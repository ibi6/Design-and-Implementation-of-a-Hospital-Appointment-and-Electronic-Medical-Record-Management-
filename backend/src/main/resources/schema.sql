...
CREATE INDEX IF NOT EXISTS idx_doctor_department_status ON doctor(department_id, status);
CREATE INDEX IF NOT EXISTS idx_schedule_date_status ON schedule(work_date, status);
CREATE INDEX IF NOT EXISTS idx_appointment_patient_status ON appointment(patient_id, status);
CREATE INDEX IF NOT EXISTS idx_appointment_doctor_status ON appointment(doctor_id, status);
CREATE INDEX IF NOT EXISTS idx_appointment_schedule ON appointment(schedule_id);
